    ...
    <>
      ...
      <div className="col-md-10 offset-md-1 flexy services-container">
        <div className="col-md-5 detail-section offset-md-">
          ...
          <p>
            We help you grow by offering unlimited Webflow design & development
            for a fixed monthly fee - from building the site from scratch to
            fixing and tweaking even the tiniest detail on your page.
          </p>
          <p>
