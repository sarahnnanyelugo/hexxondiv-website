...
function Framework() {
  ...
  const resetAnimation = () => {
    gsap.to(blueElement, { duration: 1, scale: 3, ease: "expoScale(2, 1)" });
    gsap.to(blueElement2, { duration: 1, scale: 3, ease: "expoScale(2, 1)" });
    gsap.to(blueElement3, { duration: 1, scale: 3, ease: "expoScale(2, 1)" });
  };
