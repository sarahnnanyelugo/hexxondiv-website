  ...
  return (
    <>
      <div className="framework-container  col-md-10 offset-md-1">
        ...
        <div className="offset-md-8 col-md-4 flexy flexyM first-row">
          <div className="frames small-frames col-md-6 s1">1</div>
        ...
        <div className=" col-md-12 flexy flexyM">
          ...
          <div className="frames small-frames col-md-2 s4">4</div>
          <div className="frames small-frames col-md-2 s5">5</div>
          <div className="frames small-frames col-md-2 s6">6</div>
          <div className="frames small-frames col-md-2 s7">7</div>
