  ...
  return (
    <>
      <div className="framework-container  col-md-10 offfset-md-1">
        <div className="1 framework-btns">
          <button>FRONTEND</button>
          <button>BACKEND</button>
        </div>
        <div className="offset-md-10 col-md-2 flexy flexyM">
          <div className="frames small-frames col-md-6"></div>
          <div className="frames small-frames col-md-6"></div>
        </div>{" "}
        <div className=" col-md-12 flexy flexyM">
          <div className="frames small-frames col-md-2"></div>
          <div className="frames small-frames col-md-2"></div>
          <div className="frames small-frames col-md-2"></div>
          <div className="frames small-frames col-md-2"></div>
          <div className="frames small-frames col-md-2"></div>
