...
function FrameWorks() {
  ...
  return (
    ...
    //     <div classNameName="framework-container  col-md-10 offset-md-1">
    //       {" "}
    //       <div classNameName=" col-md-12 flexy flexyM">
    //         <div classNameName="frames small-frames col-md-2 s3 zoom-in-out-box">
    //           <img classNameName="   logo" src={FW3} alt="Scholar" width="50%" />
    //           <h6>CarbonDesign </h6>
    //         </div>
    //         <div classNameName="frames small-frames col-md-2 s4">
    //           <img classNameName="   logo" src={FW4} alt="Scholar" width="50%" />
    //           <h6>Bootstrap</h6>
    //         </div>
    //         <div classNameName="frames small-frames col-md-2 s5">
    //           <img classNameName="   logo" src={FW5} alt="Scholar" width="50%" />
    //           <h6>Nodejs</h6>
    //         </div>
    //         <div classNameName="frames small-frames col-md-2 s6">
    //           <img classNameName="   logo" src={FW6} alt="Scholar" width="50%" />
    //           <h6>SCSS</h6>
    //         </div>
    //         <div classNameName="frames small-frames col-md-2 s7">
    //           <img classNameName="   logo" src={FW7} alt="Scholar" width="50%" />
    //           <h6>PHP</h6>
    //         </div>
    //         <div classNameName="frames small-frames col-md-2 s8">
    //           <img classNameName="   logo" src={FW8} alt="Scholar" width="50%" />
    //           <h6>CSS</h6>
    //         </div>
    //       </div>
    //       <div classNameName=" col-md-10 offset-md-2 flexy flexyM">
    //         <div classNameName="frames small-frames col-md-2 s9">
    //           <img classNameName="   logo" src={FW9} alt="Scholar" width="50%" />
    //           <h6>HTML</h6>
    //         </div>
    //         <div classNameName="frames small-frames col-md-2 s10">
    //           <img classNameName="   logo" src={FW10} alt="Scholar" width="50%" />
    //           <h6>Materialv Ui</h6>
    //         </div>
    //         <div classNameName="frames small-frames col-md-2 s11">
    //           <img classNameName="   logo" src={FW11} alt="Scholar" width="60%" />
    //           <h6>Python</h6>
    //         </div>
    //         <div classNameName="frames small-frames col-md-2 s12">
    //           <img classNameName="   logo" src={FW12} alt="Scholar" width="50%" />
    //           <h6>MDB</h6>
    //         </div>
    //       </div>
    //     </div>
    ...
    //       {" "}
    //       <div classNameName=" col-md-12 flexy flexyM">
    //         <div classNameName="frames small-frames col-md-2 s3">
    //           <img classNameName="   logo" src={FW3} alt="Scholar" width="50%" />
    //           <h6>CarbonDesign </h6>
    //         </div>
    //         <div classNameName="frames small-frames col-md-2 s4">
        ...
        <>
          <div classNameName="frameworks-div">
            ...
            <div classNameName="framework-cova">
              ...
              <h1>menenenenenennnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnn</h1>
            </div>
          </div>
        </>
      );
