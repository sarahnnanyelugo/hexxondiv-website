        ...
        <div className="col-md-6 offset-md-1 swipes2">
          ...
          >
            ...
            <SwiperSlide>
              ...
              <div>
                <p>
                  We integrated easily with OpenNode's API to accept bitcoin
                  transactions both on- and off-chain with minimal fuss.
                </p>
              </div>
            </SwiperSlide>
            <SwiperSlide>
              <div>
                <p>
                  Partnering with OpenNode created a better customer experience
                  by making lightning payments simple. They take care of all of
                  the backend so we can focus on creating the most comfortable
                  shoes in the world.
                </p>
              </div>
            </SwiperSlide>
