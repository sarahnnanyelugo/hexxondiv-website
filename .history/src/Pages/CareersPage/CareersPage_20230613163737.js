...
function CareersPage() {
  return (
    <>
      ...
      <h3>Internships</h3>
      <p>
        We offer a select number of organizations a free non-committal 6months
        internship with our outstanding developers prior to graduation.
      </p>
      <h3>Trainings</h3>
      At Hexxondiv Tech Hub, we provide every young and interested individual an
      opportuniy to make a life changing career growth by being a part of our 6
      months Web development training with{" "}
