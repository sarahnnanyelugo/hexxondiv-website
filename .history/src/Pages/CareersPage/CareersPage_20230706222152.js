...
function CareersPage() {
  return (
    <>
     <div className="col-md-12 page-wrapper"></div>
      ...
      <center>
        <div className="col-md-6 mt">
          ...
          <p>
            ...
            With new technologies emerging almost everyday, we want to surround
            ourselves with people who put their skills to use for a positive
            impact on the way we live and do business.
          </p>
          <p>
      ...
      <center>
        <h1 style={{ marginTop: "150px" }}>
          Here at Hexxondiv Tech Hub, <span className="highlight">we </span>hold
          on to:
        </h1>
      </center>
      ...
      <center>
        <div className="col-md-6 mt mb6">
          ...
          <p style={{ fontSize: "22px" }}>
            Click on the button below and let us know who you are! We are going
            to be in touch very soon.
          </p>
          <button className="apply-btn">Apply now</button>
        </div>
      </center>

      <Footer bg="#092540" logo={Logo} /> </div>
    </>
  );
}
