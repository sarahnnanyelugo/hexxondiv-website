...
function AboutUs() {
  return (
    <>
      ...
      <center>
        {" "}
        <div className="col-md-5 mt about-body">
          <h1>
      ...
      <div className="col-md-8 offset-md-2 ">
        <div className="flexy mt">
          <div className="col-md-6">
            <h1 className="mobile-view">Our Stor</h1>
            <img className="" src={About} alt="Scholar" width="100%" />{" "}
          </div>
          <div className="col-md-6" style={{ padding: "10px" }}>
            <h1 className="web-view">Our Story</h1>
            <p>
        ...
        <div className="flexy mt">
          <div className="col-md-6" style={{ padding: "10px" }}>
            ...
            <p>
              ...
              mission encompasses the following key components:
            </p>
            <ol>
