...
"
        ...
        <textarea rows="4" cols="70" placeholder="Your message" />{" "}
        <h6>Project description</h6>
        <input type="text" /> <h6>First name*</h6>
        <input type="text" />
        <h6>Last name*</h6>
        <input type="text" /> <h6>Company name</h6>
        <input type="text" />
        <h6>Country/Region*</h6>
        <input type="text" /> <h6>Country/Region*</h6>
        <input type="text" />{" "}
      </form>
    </div>
  );
