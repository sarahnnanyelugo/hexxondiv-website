    ...
    <>
      ...
      <div className="col-md-10 offset-md-1 flexy">
        <div className="col-md-3">
          <img className="   logo" src={Silverbird} alt="Scholar" width="50%" />
        </div>
        <div className="col-md-3">
          <img className="   logo" src={Switchapp} alt="Scholar" width="50%" />
        </div>
        <div className="col-md-3">
          <img className="   logo" src={Powerjet} alt="Scholar" width="50%" />
        </div>
        <div className="col-md-3">
