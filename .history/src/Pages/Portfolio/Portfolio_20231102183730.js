          ...
          <Carousel.Item>
            <div className="col-md-8 offset-md-2 flexy portfolio-section">
              ...
              <div className="col-md-5 offset-md-1 mt">
                <h4>BENTO DELIVAZ</h4>
                <p>
                  BENTO DELIVAZ is a platform that effortlessly integrates your
                  favorite food vendors, trusted pharmacy outlets, and
                  well-stocked supermarkets, all within a single digital realm.
                  With this application, it's time to Say goodbye to the hassle
                  of commuting, queues, and endless search for your preferred
                  vendors. With our innovative solution, you can now make
                  purchases from the comfort of your home, ensuring that every
                  shopping experience is not just convenient but also tailored
                  to your preferences. Join us as we redefine the future of
                  shopping and bring a world of choices right to your fingertips
                </p>
                <Link to={"#"} target="_blank">
                  Visit Site
                </Link>
