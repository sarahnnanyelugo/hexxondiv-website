        ...
        <div className="flexy">
          ...
          <div className="col-md-3  offset-md-1">
            <a
              ...
              className="product2-heading mt6"
              target="_blank"
            >
              Powerjet.ng
            </a>
            ...
            <p>
              PowerJet.Ng helps pay for your electricity bills online, from the
              comfort of your homes and offices, having your token printed out
              and sent to your mail or dashboard.
            </p>
          </div>
        </div>
      </div>
